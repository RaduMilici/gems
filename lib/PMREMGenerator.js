...
THREE.PMREMGenerator = function( sourceTexture ) {
	...
	this.sourceTexture.minFilter = ( monotonicEncoding ) ? THREE.NearestFilter : THREE.NearestFilter;
	this.sourceTexture.magFilter = ( monotonicEncoding ) ? THREE.NearestFilter : THREE.NearestFilter;
